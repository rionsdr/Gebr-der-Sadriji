(function () {
  ...
  const translations = {
    de: {
      ...
      'usp.card1.title':             'Starke Fachkompetenzen',
      'usp.card1.text':              'Unser Team vereint Erfahrung, Fachwissen und handwerkliches Können. So werden Arbeiten gezielt, effizient und auf hohem Qualitätsniveau ausgeführt.',
      ...
      'form.visit':                  'Besichtigung für genaue Offerte',
      'form.visit.yes':              'Ja, bitte Termin vereinbaren',
      'form.visit.no':               'Nein, zuerst grobe Einschätzung',
      'form.visit.hint':             'Für eine verbindliche Offerte ist in der Regel eine Besichtigung oder eine genaue Projektbeschreibung erforderlich.',
    ...
    en: {
      ...
      'usp.card1.title':             'Strong expertise',
      'usp.card1.text':              'Our team combines experience, technical know-how and craftsmanship. This ensures work is carried out purposefully, efficiently and to a high standard of quality.',
      ...
      'form.visit':                  'On-site visit for accurate quotation',
      'form.visit.yes':              'Yes, please schedule an appointment',
      'form.visit.no':               'No, rough estimate first',
      'form.visit.hint':             'A binding quotation usually requires an on-site visit or a detailed project description.',
    ...
    fr: {
      ...
      'usp.card1.title':             'Forte expertise métier',
      'usp.card1.text':              'Notre équipe réunit expérience, savoir-faire technique et maîtrise artisanale. Les travaux sont ainsi réalisés de manière ciblée, efficace et à un haut niveau de qualité.',
      ...
      'form.visit':                  'Visite sur place pour un devis précis',
      'form.visit.yes':              'Oui, merci de fixer un rendez-vous',
      'form.visit.no':               'Non, d\'abord une estimation approximative',
      'form.visit.hint':             'Un devis ferme nécessite généralement une visite sur place ou une description détaillée du projet.',
    ...
    it: {
      ...
      'usp.card1.title':             'Solide competenze professionali',
      'usp.card1.text':              'Il nostro team unisce esperienza, competenze tecniche e abilità artigianale. Così i lavori vengono eseguiti in modo mirato, efficiente e con un elevato livello di qualità.',
      ...
      'form.visit':                  'Sopralluogo per un preventivo preciso',
      'form.visit.yes':              'Sì, fissiamo un appuntamento',
      'form.visit.no':               'No, prima una stima indicativa',
      'form.visit.hint':             'Per un preventivo vincolante di norma è necessario un sopralluogo o una descrizione dettagliata del progetto.',
